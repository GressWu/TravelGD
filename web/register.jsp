    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="post" action="UserRegisterServlet">
                <h2 class="text-center"><strong>创建</strong> 你的账户</h2>
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">注册</button></div><a class="already" href="userlogin.jsp">如果您已经有了账户，点此登录</a></form>
        </div>
    </div>
