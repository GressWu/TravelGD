...
<div class="login-dark">
    <form method="post" action="adminLoginServlet">
        ...
        <div class="form-group"><input class="form-control" type="text" name="adminname" placeholder="管理员姓名"></div>
        <div class="form-group"><input class="form-control" type="password" name="apassword" placeholder="密码"></div>
        <div class="form-group">
            <button class="btn btn-primary btn-block" type="submit">登录</button>
        </div>
        <p style="color:red">${msg==null?"":msg}</p>
        <a class="forgot" href="userlogin.jsp">用户入口</a></form>
</div>
