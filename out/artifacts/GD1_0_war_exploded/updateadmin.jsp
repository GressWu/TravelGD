    ...
    <div id="wrapper">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li> <a href="manageinformation.html">信息管理</a></li>

                <li> <a href="managemessage.html">留言管理</a></li>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="container">
                <form class="form-horizontal" role="form" style="margin-top: 120px;" method="post" action="UpdateAdminServlet">
                    <div class="form-group">
                      <label  class="col-sm-2 control-label">管理员姓名</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="firstname" placeholder="<%=adminname%>" name="adminname">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="lastname" class="col-sm-2 control-label">管理员密码</label>
                      <div class="col-sm-10">
                        <input type="password" class="form-control" id="lastname" placeholder="<%=apassword%>" name="apassword">
                      </div>
                    </div>
                    <div class="form-group">
